...
- **CSS3** – Estilos, transiciones, gradientes y modo claro/oscuro.
- **JavaScript (ES6+)** – Interactividad, renderizado dinámico de proyectos y control de temas.
- **Bootstrap 5** – Grid responsive y componentes predefinidos.
- **LocalStorage** – Guardar la preferencia de tema (claro/oscuro).
- **Responsive Design** – Adaptable a móviles, tablets y desktops.
...
3. Navegar por las secciones usando la barra de navegación.
